...
public class MongoDataConfig implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        var exclusiveStore = new Store("6839d4104106e209e93ea39c", 1L, "Exclusive", "logo.png", "exclusive", "banner.png", List.of("Electronics", "Beauty", "Fashion", "Fragrances"), theme1, contactLinks1);
        var essentialsStore = new Store("6839d4104106e209e93ea39d", 1L, "Essentials", "logo.png", "essentials", "banner.png", List.of("Electronics", "Beauty", "Fashion", "Fragrances"), theme2, contactLinks2);
